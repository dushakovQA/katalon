...
WebUI.setText(findTestObject('Object Repository/Page_releaseTest/input_Fascia Name_fascia_name'), '123')

WebUI.delay(1)

WebUI.click(findTestObject('Page_releaseTest/button_Save'))

WebUI.delay(1)

WebUI.click(findTestObject('Page_releaseTest/button_Ok'))
